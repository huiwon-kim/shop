...
<html lang="en">
  ...
  <header role="banner" class="probootstrap-header">
    <div class="container">
        <a href="index.html" class="probootstrap-logo">GDJ5SHOP<span>.</span></a>
        ...
        <nav role="navigation" class="probootstrap-nav hidden-xs">
          <ul class="probootstrap-main-nav">
            ...
            <li><a href="ourindex.jsp">Info</a></li>
          </ul>
          ...
          <div class="col-md-8">
            ...
            <div class="page-title probootstrap-animate">
              <div class="probootstrap-breadcrumbs">
                <a href="#">Home</a><span>Members</span>
              </div>
              <h1>Login</h1>
            </div>
          ...
          <form action="<%=request.getContextPath()%>/haus/haus/customerloginAction.jsp" id="customerForm" method="post" class="probootstrap-form mb60">
            <div class="row">
              ...
              <div class="col-md-6">
               ...
               <div class="col-md-2">
                <div class="form-group">
              		<input type="submit" class="btn btn-primary" id="submit" name="submit" value="Customer Login">
             	 </div>
	           </div>
	       </div>
          </form>
          ...
          <form action="<%=request.getContextPath()%>/haus/haus/employeeloginAction.jsp" id="customerForm" method="post" class="probootstrap-form mb60">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="lname"> PW </label>
                 <input type="password" class="form-control" id="employeePass" name="employeePass">
                </div>
              </div>
        
               <div class="col-md-2">
                <div class="form-group">
              		<input type="submit" class="btn btn-primary" id="submit" name="submit" value="Employee Login">
             	 </div>
	           </div>
	       </div>
          </form>
